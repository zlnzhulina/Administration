<template>
  <div class="container">
    ...
    >
      ...
      <el-table-column prop="bannerName" label="标题" width="278px"></el-table-column>
      <el-table-column prop="img" label="橱窗图" width="178px">
        <template slot-scope="scope">
          <img :src="scope.row.img" style="width:140px;height:79px;">
        </template>
      </el-table-column>

      <el-table-column prop="url" label="描述"></el-table-column>
